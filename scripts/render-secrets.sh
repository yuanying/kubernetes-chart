...
KUBE_APISERVER_SECRET=${KUBE_APISERVER_SECRET:-"${LOCAL_KUBE_MANIFESTS_DIR}/apiserver-secret.yaml"}
KUBE_CM_SECRET=${KUBE_CM_SECRET:-"${LOCAL_KUBE_MANIFESTS_DIR}/cm-secret.yaml"}
KUBE_SCHEDULER_SECRET=${KUBE_SCHEDULER_SECRET:-"${LOCAL_KUBE_MANIFESTS_DIR}/scheduler-secret.yaml"}
